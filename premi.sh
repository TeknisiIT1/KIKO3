...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/TeknisiIT1/KIKO5/main/"
...
wget https://raw.githubusercontent.com/TeknisiIT1/KIKO5/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
